...
export const CustomPlayer = forwardRef<ReactPlayer, ReactPlayerProps>(
  (props, ref) => {
    // TODO
    ...
    return (
      ...
      >
        ...
        {popupMode === 'chapters' ? (
          <BlendContainer
            className={clsx(styles.popup, styles['popup-chapter'])}
          >
            <button
              className={styles.close}
              onClick={() => setPopupMode(undefined)}
...
const BlendContainer = ({
  ...
  <div
    className={clsx(className, styles['blend-container-position'])}
